...
```csharp
string connectionString = "Server=localhost;Port=3306;Database=waternav_log;User=waternav_app;Password=waternav_pw;";
    ...
    "WriteTo": [
      {
        "Name": "MySql",
        "Args": {
          "connectionString": "Server=localhost;Port=3306;Database=waternav_log;User=waternav_app;Password=waternav_pw;",
...
```js
"Serilog": {
    "Using": [ "Serilog.Sinks.MySql.Configuration" ],
    "MinimumLevel": "Debug",
